...
async function main(client) {
  ...
  responce = await clientAcc.run("returnLiquidity", {pairAddr:pairAddr,tokens:1000000000});
  console.log("Contract reacted to your returnLiquidity:", responce.decoded.output);
