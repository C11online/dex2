...
async function main(client) {
  ...
  let usdcAmount = 1000000000000000;
  let usdtAmount = 990000000000000;

  const pairAddr = JSON.parse(fs.readFileSync(pathJsonPairUsdcUsdt,{encoding: "utf8"})).address;

  responce = await clientAcc.run("processLiquidity", {pairAddr:pairAddr,qtyA:usdcAmount,qtyB:usdtAmount});
