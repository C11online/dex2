...
async function main(client) {
  ...
  let btcAmount = 10785140341;

  const pairAddr = JSON.parse(fs.readFileSync(pathJsonPairTonBtc,{encoding: "utf8"})).address;

  responce = await clientAcc.run("processLiquidity", {pairAddr:pairAddr,qtyA:tonAmount,qtyB:btcAmount});
