...
contract DEXPair is IDEXPair, IDEXConnect, ITokensReceivedCallback, IBurnTokensCallback  {
  ...
  // Function to get other pair root
  function getOther(address rootIn) private inline view returns (address) {
  ...
  function tokensReceivedCallback(
    ...
    if (msg.sender == walletReserve[rootA] || msg.sender == walletReserve[rootB]) {
      ...
      if (arg0 == 2) {
        tvm.rawReserve(address(this).balance - msg.value, 2);
        if (processingStatus[token_root][arg1] == false && processingStatus[getOther(token_root)][arg1] == false){
          processingStatus[token_root][arg1] = true;
          processingData[token_root][arg1] = amount;
          processingDest[token_root][arg1] = sender_wallet;
        } else if (processingStatus[token_root][arg1] == false && processingStatus[getOther(token_root)][arg1] == true) {
          processingData[token_root][arg1] = amount;
          processingDest[token_root][arg1] = sender_wallet;
          ...
          if (totalSupply == 0 && balanceReserve[rootA] == 0 && balanceReserve[rootB] == 0) {
            ...
            delete processingStatus[rootA][arg1];
            delete processingStatus[rootB][arg1];
            delete processingData[rootA][arg1];
            delete processingData[rootB][arg1];
            delete processingDest[rootA][arg1];
            delete processingDest[rootB][arg1];
        ...
        } else if (processingStatus[token_root][arg1] == true && processingStatus[getOther(token_root)][arg1] == false) {
          processingData[token_root][arg1] += amount;
        }
      }
    }
