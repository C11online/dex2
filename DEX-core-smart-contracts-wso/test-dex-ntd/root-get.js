...
// Call `getGiverAddress` function
response = await rootAcc.runLocal("getGiverAddress", {_answer_id:0, giverPubKey:pubkey});
console.log("Contract reacted to your getGiverAddress:", response.decoded.output);
