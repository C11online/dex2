...
let currentPairPath = pathJsonPairTonDai;
...
async function main(client) {
  ...
  let tonAmount = 100000000000000;
  let daiAmount = 35000000000000;

  const pairAddr = JSON.parse(fs.readFileSync(currentPairPath,{encoding: "utf8"})).address;

  responce = await clientAcc.run("processLiquidity", {pairAddr:pairAddr,qtyA:tonAmount,qtyB:daiAmount});
