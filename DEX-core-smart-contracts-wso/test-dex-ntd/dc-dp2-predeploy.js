...
const name = toHex("DS-BTC/USDT");
const symbol = toHex("DS-BTC/USDT");
const decimals = 9;
  ...
  while (!status) {
    ...
    if (shardC == targetShard) {
      ...
      if (shardW == targetShard) {
        ...
        fs.writeFileSync( pathJsonPairBtcUsdt, keyJson,{flag:'w'});
        console.log("Data for the DEXpair written successfully to:", pathJsonPairBtcUsdt);
        status = true;
      } else {console.log(n);}
    } else {console.log(n);}
    n++;
