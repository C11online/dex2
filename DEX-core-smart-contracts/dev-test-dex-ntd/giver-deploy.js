...
async function main(client) {
    ...
    if (networkSelector == 0) {
      ...
      await giver.sendTo(giverAddr, 100_000_000_000);
      console.log(`Grams were transferred from giver to ${giverAddr}`);
      ...
      response = await giverNTDAcc.run("sendTransaction", {dest:giverAddr,value:100000000000,bounce:false});
