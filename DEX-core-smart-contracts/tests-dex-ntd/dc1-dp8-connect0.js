...
const currentPair = pathJsonPairTonEth;
...
async function main(client) {
  ...
  const pairAddr8 = JSON.parse(fs.readFileSync(pathJsonPairUsdcUsdt,{encoding: "utf8"})).address;

  responce = await clientAcc.run("connectPair", {pairAddr:pairAddr8});
